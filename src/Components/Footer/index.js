            ...
            <footer className="footer section py-5">
                <div className="row">
                    <div className="col-12 col-lg-6 mb-4 mb-lg-0">
                        <p className="mb-0 text-center text-xl-left">Copyright © 2019-
                            <span className="current-year"></span> <a className="text-primary fw-normal" href="https://themesberg.com/" target="_blank">Themesberg</a>
                        </p>
                    </div>
